...
WebSocket push, scene execution, if/then rules, JSON persistence, rooms, users, \
time-based scheduling, and provides the HTTP API used by the mobile app and config dashboard."
...
FILES:${PN} += "${bindir}/propertycore-engine ${systemd_system_unitdir}/propertycore-engine.service"
