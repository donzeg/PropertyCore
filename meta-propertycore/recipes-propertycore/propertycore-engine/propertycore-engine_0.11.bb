...
WebSocket push, scene execution, if/then rules, JSON persistence, areas (renamed \
from rooms), floors, property singleton, users, time-based scheduling, PIN-based \
session auth for the mobile app, and provides the HTTP API used by the mobile app \
and config dashboard."
