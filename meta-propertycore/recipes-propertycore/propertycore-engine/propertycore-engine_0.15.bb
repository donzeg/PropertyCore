...
floors, property singleton, mobile-app users (PIN auth), InfluxDB time-series \
data pipeline, and dashboard admin accounts (username + PBKDF2 password auth). \
v0.15: scene icon/area/action-type chaining, multi-clause AND/OR rules with \
time/day conditions, schedule trigger-type field. \
Provides the HTTP API used by the mobile app and config dashboard."
